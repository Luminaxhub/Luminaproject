...
-- FakeLag Button (replacing TP Tool)
local fakeLagBtn = wsBtn:Clone()
fakeLagBtn.Text = "FakeLag"
fakeLagBtn.Position = UDim2.new(0, 10, 0, posY)
fakeLagBtn.Parent = Scroll
fakeLagBtn.MouseButton1Click:Connect(function()
	local char = LocalPlayer.Character
	if char and char:FindFirstChild("HumanoidRootPart") then
		local hrp = char.HumanoidRootPart
		hrp.Anchored = true
		task.wait(2) -- delay waktu "lag"
		hr
p.Anchored = false
	end
end)
